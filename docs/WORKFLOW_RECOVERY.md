...
- `tests/reliability-codex.browser.mjs`: actual authenticated Hub, lost HTTP acknowledgement, active/completed native turns, reload and explicit resend; exactly one native `turn/start`. Windows process effects are simulated.
