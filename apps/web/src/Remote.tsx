              ...
              <details className="remote-gesture-help">
                ...
                <p>
                  {touchMode === "trackpad"
                    ...
                    : "Касание нажимает в выбранной точке. Движение пальцем перетаскивает. Стилус управляет напрямую. Два пальца прокручивают; касание двумя пальцами — правая кнопка."}{" "}
                  Щипок меняет масштаб, три пальца двигают увеличенный экран.
                </p>
                {touchMode === "trackpad" && (
                  <label>
                    Скорость указателя
