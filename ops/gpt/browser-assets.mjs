...
export async function readAsset(page,id,sandbox,projectId){
 return page.evaluate(async ({id,sandbox,projectId})=>{
  ...
  const endpoint=projectId?'/backend-api/files/download/'+encodeURIComponent(id)+'?gizmo_id='+encodeURIComponent(projectId):sandbox?'/backend-api/conversation/'+encodeURIComponent(sandbox.conversationId)+'/interpreter/download?'+new URLSearchParams({message_id:sandbox.messageId,sandbox_path:sandbox.path}):'/backend-api/files/'+encodeURIComponent(id)+'/download';
