...
export async function readAsset(page,id){
 return page.evaluate(async id=>{
  ...
  const response=await fetch('/backend-api/files/'+encodeURIComponent(id)+'/download',{credentials:'include',headers:{Authorization:'Bearer '+session.accessToken},signal:AbortSignal.timeout(20000)});
